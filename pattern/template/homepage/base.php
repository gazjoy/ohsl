    ...
    <section class="u-clearfix" id="solutions">
        <div class="u-section-lg u-container-lg">
            ...
            <div class="grid g-gutter">
                ...
                <div class="g-col-sm-6 g-col-md-4 u-full-height">
                    <a href="/" class="card">
                        <img src="<?php echo getUrl('build/img/services/local-exhaust-ventilation.jpg'); ?>" width="590" height="325" alt="Local Exhaust Ventilation (LEV)" />
                        <div class="card__body">
                ...
                <div class="g-col-sm-6 g-col-md-4 u-full-height">
                    <a href="/" class="card">
                        <img src="<?php echo getUrl('build/img/services/hazardous-substances.jpg'); ?>" width="590" height="325" alt="Hazardous Substances (COSHH)" />
                        <div class="card__body">
                ...
                <div class="g-col-sm-6 g-col-md-4 u-full-height">
                    <a href="/" class="card">
                        <img src="<?php echo getUrl('build/img/services/indoor-air-quality-lighting.jpg'); ?>" width="590" height="325" alt="Indoor Air Quality &amp; Lighting" />
                        <div class="card__body">
                ...
                <div class="g-col-sm-6 g-col-md-4 u-full-height">
                    <a href="/" class="card">
                        <img src="<?php echo getUrl('build/img/services/occupational-hygiene-training.jpg'); ?>" width="590" height="325" alt="Occupational Hygiene Training" />
                        <div class="card__body">
